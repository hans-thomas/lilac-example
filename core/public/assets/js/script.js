...
$(function () {
  ...
  $("#amount").val(
    "تومان" + $("#slider-range").slider("values", 0) + " - تومان" + $("#slider-range").slider("values", 1)
  );
  ...
  const productGalleryTab = document.querySelectorAll(".product-gallery-tab");
  //   console.log({ productGalleryTab });
  productGalleryTab.forEach(function (gallery) {
    // console.log(gallery.dataset.gallery);
    // console.log(document.querySelector("[data-gallery='" + gallery.dataset.gallery + "'] ~ .product-thumb-tab"))
    let productPreviewTab = new Swiper("[data-gallery='" + gallery.dataset.gallery + "']", {
      spaceBetween: 1,
      touchRatio: 0,
      effect: "fade",
      navigation: {
        nextEl: "[data-gallery='" + gallery.dataset.gallery + "'] ~ .buttons .btn-next",
        prevEl: "[data-gallery='" + gallery.dataset.gallery + "'] ~ .buttons .btn-prev",
      },
      pagination: {
        el: "[data-gallery='" + gallery.dataset.gallery + "'] > .product-gallery-pagination",
        clickable: true,
      },
    });

    let productThumbsTab = new Swiper("[data-gallery='" + gallery.dataset.gallery + "'] ~ .product-thumb-tab", {
      spaceBetween: 10,
      slidesPerView: 4,
      slideToClickedSlide: true,
      slidesPerView: 3,
    ...
    $("[data-gallery='" + gallery.dataset.gallery + "'] ~ .product-thumb-tab .swiper-slide-active img").elevateZoom({
      zoomType: "inner",
      lensShape: "round",
      lensSize: 200,
      zoomWindowFadeIn: 500,
    ...
    console.log({ productThumbsTab });

    const tumbnails = document.querySelectorAll(
      "[data-gallery='" + gallery.dataset.gallery + "'] ~ .product-thumb-tab .swiper-slide"
    );

    tumbnails.forEach(function (slide) {
      slide.addEventListener("click", function (event) {
        ...
        $(
          "[data-gallery='" + gallery.dataset.gallery + "'] ~ .product-gallery-tab .swiper-slide-active img"
        ).elevateZoom({
          zoomType: "inner",
          lensShape: "round",
          lensSize: 200,
  ...
  // console.log(
  //   "test",
  //   document.querySelector("[data-gallery='" +  + "'] ~ .product-thumb-tab .swiper-slide")
  // );
  /*=========================================================
    18: contact page Google Map
    ==========================================================*/
