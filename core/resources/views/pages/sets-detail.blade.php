                        ...
                        <div class="col-lg-5 col-md-6">
                            <div class="image-area">
                                <div class="product-gallery-tab swiper-container"
                                     id="product-gallery-tab-{{ $product->id }}">
                                    <div class="swiper-wrapper">

                                        @foreach(range(1,4) as $key)
                                            <div class="item swiper-slide" id="swiper-slide-{{ $key }}">
                                                <img id="zoom_{{ $product->id }}"
                                ...
                                <div class="product-thumb-tab swiper-container"
                                     id="product-thumb-tab-{{ $product->id }}">
                                    <div class="swiper-wrapper">

                                        @foreach(range(1,4) as $key)
                                            <div class="item swiper-slide" id="swiper-slide-{{ $key }}">
                                                <img src="{{ asset("assets/images/shop/img-sm{$key}.jpg") }}"
                                                     alt="Product">
                                            </div>
                                        @endforeach
                                    </div>
